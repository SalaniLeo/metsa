...
{#if alerts.length > 0}
    ...
    <div class="border padding2 radius-medium bg-secondary bg-terthiary-hover gap2 flexcolumn" style="position: sticky; top: 1rem;">
        <div class="flexrow valign gap2 hstartalign pointer">
        ...
        <div class="alert-box flexcolumn gap2 hexpand">
