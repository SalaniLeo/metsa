...
{#if alerts.length > 0}
    ...
    <div class="bg-terthiary-hover border padding2 radius-medium flexrow gap2 valign" onclick={() => {showAlerts = !showAlerts}}>
        ...
        <h3 class="pointer">There are {alerts.length} alerts</h3>
